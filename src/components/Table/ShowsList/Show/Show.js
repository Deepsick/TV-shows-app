...
const show = props => {
  ...
  return (
    <tr className="Table__tr">
      ...
      <td className="Table__td">{props.show.aired_episodes}</td>
      <td className="Table__td">{props.show.rating.toFixed(2)}</td>
      <td className="Table__td">{props.show.year}</td>
      <td className="Table__td">{props.show.genres.join(", ")}</td>
